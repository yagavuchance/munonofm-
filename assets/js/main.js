...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const weeklyQuestion = "how would you like your business to be?";
  const deadlineDate = new Date("2023-09-07T23:59:59"); // Replace with the actual deadline date and time
